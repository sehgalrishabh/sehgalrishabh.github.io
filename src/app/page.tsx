...
const Landing = () => {
  return (
    <main className="flex min-h-screen flex-col py-16 items-center">
      <section className="w-1/2">
        ...
        <div id="social-buttons" className="mt-4">
          <PillButton icon={faGithub} title="Github" />
          <PillButton className="ms-4" icon={faLinkedin} title="LinkedIn" />
          <PillButton className="ms-4" icon={faEnvelope} title="Email" />
        </div>
